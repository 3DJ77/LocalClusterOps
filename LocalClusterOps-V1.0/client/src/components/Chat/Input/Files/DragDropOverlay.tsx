  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center rounded-3xl border border-white/10 bg-slate-950/70 p-8 shadow-[0_30px_80px_rgba(2,6,23,0.45)] backdrop-blur-xl">
          <svg
          ...
          <h4 className="text-sm text-cyan-100/70">{localize('com_ui_drag_drop')}</h4>
        </div>
      </div>
    </>
  );
