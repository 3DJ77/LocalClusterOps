      ...
      <div className="relative flex h-full flex-1 items-stretch md:flex-col">
        <div className={cn('flex w-full items-center', isRTL && 'flex-row-reverse')}>
          ...
          <div
            ...
            className={cn(
              'relative flex w-full flex-grow flex-col overflow-hidden rounded-t-lg border pb-4 text-[#dbe9ff] shadow-[0_12px_28px_rgba(0,10,30,0.28)] transition-all duration-200 sm:rounded-lg sm:pb-0',
              isTextAreaFocused ? 'border-[#74adff] shadow-[0_0_0_1px_rgba(116,173,255,0.35)]' : '',
              isTemporary ? 'border-[#74adff] bg-[#0d356b]' : 'border-[#274b7d] bg-[#061d42]',
            )}
          >
                ...
                >
                  <TextareaAutosize
                    ...
                    className={cn(
                      baseClasses,
                      removeFocusRings,
                      'scrollbar-hover text-[#dbe9ff] caret-[#74adff] transition-[max-height] duration-200 placeholder:text-[#8198bb] disabled:cursor-not-allowed',
                    )}
                  />
                </div>
