        ...
        <div className={'relative w-full'}>
          <Trigger asChild>
            <button
              ...
              className={cn(
                'pointer-cursor relative flex w-full min-w-0 flex-col rounded-lg border border-black/10 bg-white py-2 pl-3 pr-10 text-left focus:ring-0 focus:ring-offset-0 dark:border-gray-700 dark:bg-gray-800 sm:text-sm',
            ...
            >
              ...
              <span className="inline-flex w-full">
                <span
                  className={cn(
                    'flex h-6 min-w-0 items-center gap-1 truncate text-sm text-text-primary',
                    !showLabel ? 'text-xs' : '',
                    'font-normal',
                  )}
                >
          ...
          <Portal>
            <Content
              ...
              align="start"
              className={cn(
                'z-50 mt-2 min-w-[var(--radix-popover-trigger-width)] max-w-[min(90vw,32rem)] overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-700 dark:text-white lg:max-h-[52vh]',
